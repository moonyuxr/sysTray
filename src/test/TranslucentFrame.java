...
public class TranslucentFrame implements Runnable {
  ...
  public static void main(String[] args) {
    String title = "友情提示！";
    String message = "<strong>JDK1.6新特性测试</strong><br>《透明窗体》<br>www.oschina.net<br>CSDN";
  ...
  public void print() {
    ...
    int x = Toolkit.getDefaultToolkit().getScreenSize().width
      - Toolkit.getDefaultToolkit().getScreenInsets(frame.getGraphicsConfiguration()).right - width - 5;
    int y = Toolkit.getDefaultToolkit().getScreenSize().height
      - Toolkit.getDefaultToolkit().getScreenInsets(frame.getGraphicsConfiguration()).bottom - height - 5;

...
public class TestJOptionPane implements ActionListener {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (s.equals("错误")) {
      JOptionPane.showMessageDialog(null, "要显示的错误信息---", "错误提示", JOptionPane.ERROR_MESSAGE);
    } else if (s.equals("退出确认1")) {
      int result = JOptionPane.showConfirmDialog(null, "推出前是否保存程序？");
      ...
      int result = JOptionPane.showOptionDialog(null, "本操作可能导致数据丢失", "Warning", JOptionPane.DEFAULT_OPTION,
